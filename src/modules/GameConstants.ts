...
export const PLAYER_BOMB_DESTROY_CHANCE_BASE = 0.75; // 75%
export const PLAYER_BOMB_DESTROY_CHANCE_DECREASE_PER_LEVEL = 0.025; // 2.5% per level
export const PLAYER_BOMB_DESTROY_CHANCE_MINIMUM = 0.0; // 0%

export const HELPER_BOMB_DESTROY_CHANCE_BASE = 0.8; // 80%
export const HELPER_BOMB_DESTROY_CHANCE_DECREASE_PER_LEVEL = 0.02; // 2% per level
export const HELPER_BOMB_DESTROY_CHANCE_MINIMUM = 0.05; // 5%
