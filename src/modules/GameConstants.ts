...
export const PLAYER_BOMB_DESTROY_CHANCE_BASE = 0.9; // 90%
export const PLAYER_BOMB_DESTROY_CHANCE_DECREASE_PER_LEVEL = 0.025; // 2.5% per level
export const PLAYER_BOMB_DESTROY_CHANCE_MINIMUM = 0.05; // 5%

export const HELPER_BOMB_DESTROY_CHANCE_BASE = 0.9; // 90%
